...
struct CityDetailsModalView: View{
    ...
    init(searchingFor: Binding<String>, myCities: Binding<[City]>, city: City, tabSelection: Binding<Int>, ForecastVM: ForecastViewModel = ForecastViewModel()) {
        self._tabSelection = tabSelection
        self._searchingFor = searchingFor
        self._myCities = myCities
        self.city = city
